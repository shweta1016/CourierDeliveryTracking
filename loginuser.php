...
require_once('libraryuserlogin.php');
$error = "";
if(isset($_POST['txtemail'])){
	$error = checkUser($_POST['txtemail'],$_POST['txtpassword']);
}
...
<?php include("head.php"); ?>
      ...
      <form action="track-status.php? method="post" name="frmShipment" >
          <table border="0" cellpadding="0" cellspacing="0" align="center" width="500">
            ...
            <tr>
              ...
              <td><table border="0" cellpadding="0" cellspacing="0" align="center" width="98%">
                        ...
                        <form name="form1" id="form1" method="post" onSubmit="return memloginvalidate()">
                          <td><table bgcolor="#FFFFFF" border="0" cellpadding="3" cellspacing="1" width="100%">
               ...
               </td> <div class="headtext13" align="left"><strong>Customer Login Page </strong></div>
            </div>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td width="3">:</td>
                                <td width="160">
								<input name="txtemail" class="forminput" id="txtemail" maxlength="20" type="email" required></td>
                              </tr>
                              <tr>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:16px;">Password</font></td>
                                <td>:</td>
                                <td><input name="txtpassword" class="forminput" id="txtpassword" maxlength="20" type="password" required></td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td><input name="Submit" class="green-button" value="Login Now" type="submit" style="padding:5px 5px;font-weight:bold;">
