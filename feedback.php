...
<?php include("headfeed.php"); ?>
      ...
      <tr>
       ...
       <form action="feedbackprocess.php" method="post" name="frmShipment" >
          <table border="0" cellpadding="0" cellspacing="0" align="center" width="500">
            ...
            <tr>
              ...
              <td><table border="0" cellpadding="0" cellspacing="0" align="center" width="98%">
               ...
               </td> <div class="headtext13" align="left"><strong>You want to give feedback </strong></div>
            </div>
                              </tr>
                              <tr>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:16px;">Name</font></td>
                                <td>:</td>
                                <td><input name="txtname" class="forminput" id="name" maxlength="20" type="text" required></td>
                              </tr>
				
                              </tr>
                              <tr>
                                <td width="115">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:16px;">Email</font></td>
                                <td width="3">:</td>
                                <td width="160">
								<input name="txtemail" class="forminput" id="email" maxlength="20" type="email" required></td>
                              </tr>
                             <tr>
                                <td width="115">&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:16px;">Feddback</font></td>
                                <td width="3">:</td>
                                <td width="160">
								<input name="txtmsg" class="forminput" id="msg" maxlength="100" type="text" required></td>
                              </tr>
                              
                              <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td><input name="Submit" class="green-button" value="Submit" type="submit" style="padding:5px 5px;font-weight:bold;">
      ...
      <tr>
    <td><table border="0" cellpadding="0" cellspacing="0" align="center" width="870">
  <tbody><tr>
    <td bgcolor="#2284d5" height="40" width="400">&nbsp;</td>
