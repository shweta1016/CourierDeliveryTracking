...
<title>Courier / Order Tracking Script</title>
 ...
 if (form.Consignment.value == "" )
		 {
          ...
          <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td> <td bgcolor="#99CCFF" width="125"><div align="center"><a href="feedback.php? class="headtext13">Feedback</a></div></td> <td bgcolor="#99CCFF" width="125"><div align="center"><a href="loginuser.php? class="headtext13">Logout</a></div></td>
              <tbody><tr>
         
                <td class="TrackTitle" valign="top"><div class="newtext" align="center"><strong> Track and Trace your Orders <br>
                        </strong></div></td>
              </tr>
              <tr>
